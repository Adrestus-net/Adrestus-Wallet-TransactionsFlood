...
const App = () => {
  ...
  useEffect(() => {
      ...
      const start = async function(a, b) {
          const result1 = await apiRequest(Testnet.TRANSACTION_URL, 'POST', transactionModel1, localStorage.getItem("bearer"));
          const result2 = await apiRequest(Testnet.TRANSACTION_URL, 'POST', transactionModel1, localStorage.getItem("bearer"));
